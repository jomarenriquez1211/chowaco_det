            ...
            for uploaded_file in uploaded_files:
                ...
                with st.expander("Show/Hide Processing Details"):
                    ...
                    if not pdf_text.strip():
                        ...
                        prompt = f""" You are an intelligent data extraction assistant specialized in agricultural and environmental reports. Analyze the following text extracted from a PDF and extract relevant information according to the ExtractedReport JSON schema described below. 
                        Input Text: {pdf_text} 
